...
import resume from './mrp-resume.pdf';
    ...
    render() {
        return (
            ...
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <a target="_blank" href="https://matthewpalmer9.github.io/" className="mr-5 hover:text-gray-900">Blog</a>
                <a target="_blank" href="https://github.com/MatthewPalmer9" className="mr-5 hover:text-gray-900">Github</a>
                </nav>
