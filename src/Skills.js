        ...
        return(
            ...
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col text-center items-center">
                    ...
                    <a target="_blank" href="https://www.w3schools.com/html/html_summary.asp#:~:text=HTML%20is%20the%20universal%20markup,browser%20can%20read%20and%20display."className="mt-3 text-blue-500 inline-flex items-center">Learn More
                ...
                <div className="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col text-center items-center">
                    ...
                    <a target="_blank" href="http://www.landofcode.com/css-tutorials/css-summary.php#:~:text=CSS%20summary,on%20webpages%20and%20their%20layout." className="mt-3 text-blue-500 inline-flex items-center">Learn More
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                        </svg>
                    </a>
                ...
                <div className="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col text-center items-center">
                    ...
                    <a target="_blank" href="https://www.tutorialspoint.com/javascript/javascript_overview.htm#:~:text=JavaScript%20is%20a%20dynamic%20computer,language%20with%20object%2Doriented%20capabilities." className="mt-3 text-blue-500 inline-flex items-center">Learn More
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                        </svg>
                    </a>
                ...
                <div className="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col text-center items-center">
                    ...
                    <a target="_blank" href="https://www.tutorialspoint.com/ruby/ruby_overview.htm#:~:text=Features%20of%20Ruby&text=Ruby%20is%20a%20general%2Dpurpose,Gateway%20Interface%20(CGI)%20scripts." className="mt-3 text-blue-500 inline-flex items-center">Learn More
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                        </svg>
                    </a>
